...
public class Platform_07 : MonoBehaviour
{
    ...
    public GameObject object_TNT_Left;
    ...
    void Start()
    {
        ...
        objectActive_Right = Random.Range(0, 3);
        ...
        {
            object_TNT_Left.SetActive(true);

            object_TNT_Left.transform.position = new Vector2(object_TNT_Left.transform.position.x, object_TNT_Left.transform.position.y);
        }
